function [ R_biot ] = biot_func( freq, theta )
%biot_func Returns reflection coefficient calculated by Biot theory
...
R_biot = (1 - rho_0*omega./Z./gamma_0)./(1 + rho_0*omega./Z./gamma_0) ;
